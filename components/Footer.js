  ...
  const socialLinks = [
    {
      ...
      // SVG from Simple Icons: https://simpleicons.org/icons/linkedin.svg
      icon: (
    ...
    },
    {
      ...
      // SVG from Simple Icons: https://simpleicons.org/icons/instagram.svg
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    },
    {
      ...
      // SVG from Simple Icons: https://simpleicons.org/icons/github.svg
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    },
    {
      ...
      // SVG from Simple Icons: https://simpleicons.org/icons/spotify.svg
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
